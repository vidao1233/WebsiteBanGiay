...
@WebServlet(urlPatterns = {"/searchAjaxPriceUnder100Shop"})
public class SearchAjaxPriceUnder100ShopControl extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = prod.searchPriceUnder100();
