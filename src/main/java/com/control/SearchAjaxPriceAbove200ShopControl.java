...
@WebServlet(urlPatterns = {"/searchAjaxPriceAbove200Shop"})
public class SearchAjaxPriceAbove200ShopControl extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = prod.searchPriceAbove200();
