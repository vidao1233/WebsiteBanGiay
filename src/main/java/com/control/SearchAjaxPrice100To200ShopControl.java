...
@WebServlet(urlPatterns = {"/searchAjaxPrice100To200Shop"})
public class SearchAjaxPrice100To200ShopControl extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = prod.searchPrice100To200();
