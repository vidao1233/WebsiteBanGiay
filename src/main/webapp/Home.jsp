...
.carousel-item:nth-child(1) {
	background-image:
		url('https://drake.vn/image/cache/catalog/H%C3%ACnh%20content/chirstmas-sale-2022/web-sale-xmas-2022-16-25-12-22-1500x560.jpg');
...
.carousel-item:nth-child(2) {
	background-image:
		url('https://drake.vn/image/catalog/banner/Banner%20danh%20muc%20trang%20chu/03.2022/SALE-UP-TO-70_-0322.jpg');
	background-repeat: no-repeat;
	background-size: 1520px 568px;
	background-position: center center;
}

.carousel-item:nth-child(3) {
	background-image:
		url('https://censor.vn/wp-content/uploads/2022/02/banner-censor-sneaker-1-1400x506.png');
	background-repeat: no-repeat;
	background-size: 1400px 506px;
	background-position: center center;
}
		...
		<div class="row" style="margin-top: 50px">
			<div class="col-sm-12">
				<div id="content" class="row">
					...
					<div class=" col-12 col-md-12 col-lg-6">
						<img class="card-img-top"
							src="https://toplist.vn/images/800px/bitis-560412.jpg"
							alt="Card image cap">
					</div>
				</div>
			</div>
